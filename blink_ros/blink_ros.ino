#include <ros.h> // ros header file for arduino.
 ...
 * Running topic to read published (subscribe) data we do:  rostopic echo button_press (name of subscriber)
 * Running topic to publish data we do: rostopic pub toggle_led (name of publisher) std_msgs/UInt16 "data: 0"
 */
 
ros::NodeHandle node_handle; // this instantiate the nodes handle, allows our program to create 
                             // publishers and subscribers. it also takes care of serial communication.
